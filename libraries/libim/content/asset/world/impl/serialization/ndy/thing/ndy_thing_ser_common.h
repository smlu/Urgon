...
namespace libim::content::asset {
    ...
    enum class NdyThingParam
    {
        ...
        CollWidth      = 74,
        VoiceColor     = 75,
        Perflevel      = 76  // performance level
    };
    ...
    static const std::map<NdyThingParam, std::string_view> kNdyThingParamMap {
        ...
        { NdyThingParam::Perflevel      , "perflevel"sv      }
    };
    ...
    static const std::map<std::string_view, NdyThingParam> kNdyThingParamNameMap {
        ...
        { "perflevel"sv      , NdyThingParam::Perflevel      }
    };
}
